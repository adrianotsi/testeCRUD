...
if (isset($_GET['idjuridica'])) {
    $idjuridica = $_GET['idjuridica'];
} else {
    echo "<script>alert('Requisição Inválida');history.back();</script>";
}
//conectar no banco
require "app/conecta.php";
$sqlN = "select nome_fantasia from p_juridica where id_juridico = ?";
...
$sql = "select n.id_telefone id_telefone,n.numero telefone, n.tipoT as tipo
        from telefone n 
        inner join p_juridica p 
        on (n.id_juridico = p.id_juridico) 
        where n.id_juridico = ?";
...
$sqlE ="select
        ...
        from endereco e 
        inner join p_juridica p 
        on (e.id_juridico = p.id_juridico) 
        where e.id_juridico = ?";
$consultaE = $pdo->prepare($sqlE);
$consultaE->bindParam(1, $idjuridica);
$consultaE->execute();
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="index.php?op=lista&pg=pessoaJuridica">Lista de PJ</a></li>
        <li class="breadcrumb-item active" aria-current="page"><?php echo $nomeFantasia; ?></li>
    </ol>
</nav>
<div class="card text-center">
                        ...
                        <table class="table table-hover">
                            ...
                            while ($dados = $consulta->fetch(PDO::FETCH_OBJ)) {
                                ...
                                echo "<tr>
                                        ...
                                        <td>
                                            ...
                                            <a href='index.php?op=novo&pg=numero&idjuridica=$idjuridica&idtelefone=$id_telefone' class='btn'>
                            ...
                            if ($vazio == true) {
                                echo "<tr>
                                        ...
                                        <td>
                                            <a href='index.php?op=novo&pg=numero&idjuridica=$idjuridica' class='btn'>
                        ...
                        <table class="table table-hover">
                            ...
                            while ($dadosE = $consultaE->fetch(PDO::FETCH_OBJ)) {
                                ...
                                echo "<tr>
                                        ...
                                        <td>
                                            ...
                                            <a href='index.php?op=novo&pg=endereco&idjuridica=$idjuridica&idendereco=$id_endereco' class='btn'>
                                                <i class=\"fas fa-edit\"></i>
                                            </a>
                                        </td>
				                       </tr>";
                            ...
                            if ($vazioE == true) {
                                echo "<tr>
                                        ...
                                        <td>
                                            <a href='index.php?op=novo&pg=endereco&idjuridica=$idjuridica' class='btn'>
                                                <i class=\"fas fa-plus-circle\"></i>
                                            </a>
                                        </td>
                                      </tr>";
    ...
    <div class="card-footer text-muted">
        <a class="btn btn-info" href='index.php?op=novo&pg=numero&idjuridica=<?php echo $idjuridica; ?>'>
            <i class="fas fa-plus-circle"></i> Novo Número
        </a>
        <a class="btn btn-info" href='index.php?op=novo&pg=endereco&idjuridica=<?php echo $idjuridica; ?>'>
